...
func main() {
	...
	flag.BoolVar(&preParsed, "preparsed", false, "(Optional) If true, looks for pre-parsed images under ./dicom_pngs or ./merged_pngs under the dicom-path folder (useful if images are pre-parsed as PNGs)")
